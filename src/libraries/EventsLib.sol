...
import {Id} from "@canal/interfaces/ICanal.sol";
...
library EventsLib {
    ...
    /// @notice Emitted when a new VaultEvo vault is created.
    /// @param vaultEvo The address of the VaultEvo vault.
    /// @param caller The caller of the function.
    /// @param initialOwner The initial owner of the VaultEvo vault.
    /// @param initialTimelock The initial timelock of the VaultEvo vault.
    /// @param asset The address of the underlying asset.
    /// @param name The name of the VaultEvo vault.
    /// @param symbol The symbol of the VaultEvo vault.
    /// @param salt The salt used for the VaultEvo vault's CREATE2 address.
    event CreateVaultEvo(
        address indexed vaultEvo,
